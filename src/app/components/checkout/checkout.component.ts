...
export class CheckoutComponent implements OnInit {
  ...
  reviewCartDetails() {
    ...
    //subscribe to the cart service.totalQuantity
    ...
    //subscribe to cartservice.totalparice
  ...
  handleMonthsAndYears() {
    console.log('A gya isme');

    const creditCardFormGroup = this.checkoutFormGroup.get('creditCard');
    console.log('creditCardFormGroup is ' + creditCardFormGroup);
    const currentYear: number = new Date().getFullYear();
    const selectedYear: number = Number(creditCardFormGroup.value.expirationYear);

    //if the current years == selected year then start with the current month
  ...
  onSubmit() {
    console.log(`Handling a form submission`);
